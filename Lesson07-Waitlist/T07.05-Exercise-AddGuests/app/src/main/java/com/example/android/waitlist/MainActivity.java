...
//        TestUtil.insertFakeData(mDb);
  ...
  public void addToWaitlist(View view) {
    ...
    if (mNewPartySizeEditText == null || mNewGuestNameEditText == null) {
      return;
    }
...
mNewPartySizeEditText.clearFocus();
  ...
  public void addGuest() {
    ...
    contentValues.put(WaitlistEntry.COLUMN_GUEST_NAME, mNewGuestNameEditText.getText().toString());
    // TODO (7) call put to insert the party size value with the key COLUMN_PARTY_SIZE
    contentValues.put(WaitlistEntry.COLUMN_PARTY_SIZE,
